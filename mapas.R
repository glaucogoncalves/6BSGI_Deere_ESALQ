...
################ RF - A ################
dados = read.csv("./dados/mapaRF-A-200x200.csv",header = T)
dados = dados %>% dplyr::select(2:4)
geraMapa(dados,200,"RF (A)", salvar = gerarPNG)

################ RF - B ################
dados = read.csv("./dados/mapaRF-B-200x200.csv",header = T)
dados = dados %>% dplyr::select(2:4)
geraMapa(dados,200,"RF (B)", salvar = gerarPNG)

################ SPDE - A ################
dados = read.csv("./dados/spde_teste_Ca_A.csv",header = T)
dados = dados %>% select(1:3)
geraMapa(dados,122,"SPDE (A)", salvar = gerarPNG)

################ SPDE - B ################
dados = read.csv("./dados/spde_teste_Ca_B.csv",header = T)
dados = dados %>% select(1:3)
geraMapa(dados,122,"SPDE (B)", salvar = gerarPNG)

################ RBF - A ################
dados = read.csv("./dados/res_rbf_A_200_200.csv",header = T)
geraMapa(dados,135,"RBF (A)", salvar = gerarPNG)

################ RBF - B ################
dados = read.csv("./dados/res_rbf_B_200_200.csv",header = T)
geraMapa(dados,135,"RBF (B)", salvar = gerarPNG)

################ RBF - PU - A ################
dados = read.csv("./dados/res_pu_A_200_200.csv",header = T)
geraMapa(dados,135,"RBF PU (A)", salvar = gerarPNG)

################ RBF - PU - B ################
dados = read.csv("./dados/res_pu_B_200_200.csv",header = T)
geraMapa(dados,135,"RBF PU (B)", salvar = gerarPNG)

################ RF + Features - A ################
dados = read.csv("./dados/malha_saulo_A_200x200.csv",header = T)
dados = dados %>% dplyr::select(1:2,4)
geraMapa(dados,135,"RF + Features (A)", salvar = gerarPNG)

################ RF + Features - B ################
dados = read.csv("./dados/malha_saulo_B_200x200.csv",header = T)
dados = dados %>% dplyr::select(1:2,4)
...
################ RBF - IMQ - A ################
dados = read.csv("./dados/rbf_imq_200x200_A.csv",header = T)
dados = dados %>% dplyr::select(2:3,4)
geraMapa(dados,175,"RBF IMQ (A)", salvar = gerarPNG)

################ RBF - IMQ - B ################
dados = read.csv("./dados/rbf_imq_200x200_B.csv",header = T)
dados = dados %>% dplyr::select(2:3,4)
geraMapa(dados,175,"RBF IMQ (B)", salvar = gerarPNG)

################ MLS - A ################
dados = read.csv("./dados/MLS_A_mean.csv",header = F)
geraMapa(dados,240,"MLS (A)", salvar = gerarPNG)

################ MLS - B ################
dados = read.csv("./dados/MLS_B_mean.csv",header = F)
geraMapa(dados,240,"MLS (B)", salvar = gerarPNG)

################ MLS - A ################
dados = read.csv("./dados/MLS_A_var.csv",header = F)
geraMapa(dados,240,"MLS (A) - Var", salvar = gerarPNG)

################ MLS - B ################
dados = read.csv("./dados/MLS_B_var.csv",header = F)
